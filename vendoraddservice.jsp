...
<table >
	...
	<p>
		...
		</select> &emsp;&emsp;<b>Categories: &emsp;&emsp;</b> <select name="category" id="category"
			style="padding: 10px 20px;">
			<option value="">Select</option>
		</select><br> <br> <b>Other Category:&emsp;&emsp;</b>&emsp;&emsp;
		...
		<br> <br> <b style="color: red;">To Remove the service:</b>&emsp;&emsp;
		<select name="servicetype1" id="servicetype1"
			...
			<option value="">Select</option>
		</select><br> <br> <b>Other Category</b><input size="50" type="text"
