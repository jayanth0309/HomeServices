...
<body>
	...
	<form name="myForm" action="VendorLoginServlet" method="post">
		<br> <br> <label><b>FirstName:</b></label> <input
			...
			name="personage1"><br> <label><b> Please
				select your gender:</b></label> <input type="radio" id="male" name="gender1"
		...
		<label><b>Contact Number:</b></label> <input type="tel" size="50"
